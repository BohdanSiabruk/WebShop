            ...
            <div class="content">
                <div class="section group">
                    <div class="col span_2_of_3">
                       ...
                       <c:if test = "${empty sessionScope.email}">
                        		<label><a href="/login.jsp">Please, login</a></label>
                        </c:if>

                       <c:if test = "${!empty sessionScope.email}">
                         <form method="post" action="/order" id="register-form" ">

                        <h2>fill a form - <label>"${requestScope.id}"</label></h2>


                            <div>
                                  <select name="variantPayment">
                                  <option value="">Choose variant payment</option>
                                  <option value="visa">Visa</option>
                                  <option value="mastercard">mastercard</option>
                                </select>
                            </div>
                            <div>
                                <span><input value="${cardValue}" name="cardValue" type="text"
                                            placeholder="value of card"></span>
                            </div>

                            <div>
                                <span><input id="butt" type="submit" class="myButton" value="buy"></span>
                            </div>
