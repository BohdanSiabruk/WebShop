...
@WebServlet(BASKET_SERVLET_PLUS)
public class BasketServletPlus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (plus != null) {
            basket.addProductToBasket(basket.findById(Integer.parseInt(id)), Integer.parseInt(id));
        }
